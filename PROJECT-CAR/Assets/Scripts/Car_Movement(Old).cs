...
public class Car_Movement1 : MonoBehaviour
{
    ...
    private void HandlingMotor()
    {
        ...
        if (currentSpeed < maxSpeed)
        {
            ...
            if (drive == DifferentialTypes.AllWheelDrive)
            {
                ...
                {
                    wheels4[i].motorTorque = /*verticalInput +*/ m_PlayerMovement.y /** totalPowerInCar*/ * (engineTorque / 4);
                }
            }
            else if (drive == DifferentialTypes.RearWheelDrive)
            {
                ...
                {
                    wheels4[i].motorTorque = /*verticalInput +*/ m_PlayerMovement.y/* * totalPowerInCar*/ * (engineTorque / 2);
                }
            }
    ...
    */
    ...
    private void calculatingEnginePower()
    {
        ...
        totalPowerInCar = enginePower.Evaluate(engineRPM) * gearSpeedBox[gearNum];
        //engineRPM = Mathf.SmoothDamp(engineRPM, 1000 + (Mathf.Abs(EngineRPMSystem()) * (gearSpeedBox[gearNum])), )
